...
def find_path_by_greedy_best_first_search_euclidian(screen: pygame.display.set_mode, maze: Maze):
    ...
    while frontier:
        current_terrain = frontier.pop(-1)
        ...
        frontier = [terrain for terrain in sorted(frontier, key=lambda _terrain: _terrain.heuristic_value_by_euclidian(destination=maze.end), reverse=True)]

...
def find_path_by_greedy_best_first_search_manhattan(screen: pygame.display.set_mode, maze: Maze):
    ...
    while frontier:
        ...
        frontier = [terrain for terrain in sorted(frontier, key=lambda _terrain: _terrain.heuristic_value_by_manhattan(destination=maze.end), reverse=True)]

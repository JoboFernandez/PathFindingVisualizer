...
def find_path_by_astar_search_euclidian(screen: pygame.display.set_mode, maze: Maze):
    ...
    while frontier:
        ...
        frontier = [terrain for terrain in sorted(frontier, key=lambda _terrain: _terrain.heuristic_distance_by_euclidian(destination=maze.end), reverse=True)]
